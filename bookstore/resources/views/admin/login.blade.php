...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{URL::asset('storage/css_js_admin/')}}/images/favicon.png" />
</head>
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img src="{{URL::asset('storage/css_js_image_admin/')}}/image/logo.png" alt="logo">
                            </div>
                            <h4>Hello! Welcome To BookStore</h4>
                            <h6 class="font-weight-light">Sign in to continue.</h6>
                            <form class="pt-3" method="POST">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username" name="email" value="{{old('email')}}">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" name="dienthoai" value="{{old('dienthoai')}}">
                                </div>
                                <div class="mt-3">
                                    <input type="submit" value=" Đăng Nhập" name="btnDangNhap" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">
                                </div>
